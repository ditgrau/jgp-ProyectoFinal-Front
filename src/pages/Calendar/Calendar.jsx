...
import { getMyEvents, getEventsByType, getMyGroups, myEventsByType } from '../../services/apiCalls';
                ...
                <Row className='main-row mb-5'>
                    <Col xs={11} sm={8} md={7} lg={5} xl={4} className='mb-5'>
                        ...
                        {/* <div className='elements-row mb-4'>
                            <div className='main-big-bttn pink-bttn cursor' onClick={() => {typeHandler(1)}}>
                                <div className='
                            emoji'>🎖️</div></div>
                            <div className='main-big-bttn pink-bttn cursor' onClick={() => {typeHandler(2)}}><div className='
                            emoji'>⚡</div></div>
                            <div className='main-big-bttn pink-bttn cursor' onClick={() => {typeHandler(3)}}><div className='
                            emoji'>🎉</div></div>
                        </div> */}
                        {
